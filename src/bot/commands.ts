/**
 * @file Sets up command handlers for the Telegraf bot.
 */
...
/**
 * Registers command handlers with the Telegraf bot instance.
...
export function setupCommands(
  ...
  bot.command('settings', (ctx) => {
     // Handler for the /settings command, replies with a button to open the Mini App.
   ...
   bot.command('list_mcps', async (ctx) => {
        // Handler for the /list_mcps command. Fetches and lists the user's configured MCP servers.
